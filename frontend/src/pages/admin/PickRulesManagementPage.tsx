        ...
        <>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure different pick rules for the first half (weeks 1-20) and second half
                (weeks 21-38) of the season
              </CardDescription>
            </CardHeader>
            <CardContent>
              {loadingRules ? (
          ...
          <Card>
            ...
            <CardContent className="space-y-2 text-sm">
              <p>
                <strong>Max times a team can be picked:</strong> Limits how many times a user can
                select the same team in a half of the season.
              </p>
              <p>
                <strong>Max times an opposition can be targeted:</strong> Limits how many times a
                user can pick teams playing against the same opposition in a half.
              </p>
              <p className="pt-2 text-muted-foreground">
                Example: If both are set to 1, users can only pick each team once per half, and can
                only target each opposition once per half. Setting to 20 (first half) or 18 (second
                half) allows picking every week in that half.
              </p>
            </CardContent>
          </Card>
        </>
