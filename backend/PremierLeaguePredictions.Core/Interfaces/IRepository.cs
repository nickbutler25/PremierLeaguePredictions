...
public interface IRepository<T> where T : class
{
    ...
    Task<IEnumerable<T>> FindAsync(Expression<Func<T, bool>> predicate, bool trackChanges, CancellationToken cancellationToken = default);
    ...
    Task<T?> FirstOrDefaultAsync(Expression<Func<T, bool>> predicate, bool trackChanges, CancellationToken cancellationToken = default);
